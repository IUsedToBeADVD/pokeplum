...
ArchetaFrontpic:      INCBIN "gfx/pokemon/archeta/front.animated.2bpp.lz"
...
CreeptureFrontpic:     INCBIN "gfx/pokemon/creepture/front.animated.2bpp.lz"
...
SnomyomiFrontpic:    INCBIN "gfx/pokemon/snomyomi/front.animated.2bpp.lz"
...
GubblerFrontpic:     INCBIN "gfx/pokemon/gubbler/front.animated.2bpp.lz"
...
Dudunsparce_ThreeFrontpic:   INCBIN "gfx/pokemon/dudunsparce_three/front.animated.2bpp.lz"
JynxFrontpic:        INCBIN "gfx/pokemon/jynx/front.animated.2bpp.lz"
Gyarados_sFrontpic:   INCBIN "gfx/pokemon/gyarados_s/front.animated.2bpp.lz"
...
SnomyomiBackpic:     INCBIN "gfx/pokemon/snomyomi/back.2bpp.lz"
...
MinkeyFrontpic:      INCBIN "gfx/pokemon/minkey/front.animated.2bpp.lz"
...
Dudunsparce_TwoBackpic:     INCBIN "gfx/pokemon/dudunsparce_two/back.2bpp.lz"
...
GubblerBackpic:      INCBIN "gfx/pokemon/gubbler/back.2bpp.lz"
...
MagnelockeBackpic:        INCBIN "gfx/pokemon/magnelocke/back.2bpp.lz"
...
Dudunsparce_ThreeBackpic:    INCBIN "gfx/pokemon/dudunsparce_three/back.2bpp.lz"
...
PubbleBackpic:     INCBIN "gfx/pokemon/pubble/back.2bpp.lz"
ArchetaBackpic:       INCBIN "gfx/pokemon/archeta/back.2bpp.lz"
...
CreeptureBackpic:      INCBIN "gfx/pokemon/creepture/back.2bpp.lz"
...
PubbleFrontpic:    INCBIN "gfx/pokemon/pubble/front.animated.2bpp.lz"
...
MagnelockeFrontpic:  INCBIN "gfx/pokemon/magnelocke/front.animated.2bpp.lz"
...
Dudunsparce_TwoFrontpic:    INCBIN "gfx/pokemon/dudunsparce_two/front.animated.2bpp.lz"
