	...
	tilepal 0, GRAY, GRAY, GRAY, BROWN, GRAY, BROWN, GRAY, GRAY
	tilepal 0, GRAY, GRAY, GRAY, GREEN, GREEN, GREEN, WATER, GRAY
	tilepal 0, GRAY, GRAY, GRAY, BROWN, GRAY, BROWN, YELLOW, GRAY
