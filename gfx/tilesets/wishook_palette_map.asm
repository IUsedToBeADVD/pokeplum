	...
	tilepal 0, GRAY, GRAY, GRAY, GREEN, GREEN, GREEN, RED, GRAY
	tilepal 0, GRAY, GRAY, GRAY, BROWN, BROWN, GRAY, YELLOW, GRAY
	tilepal 1, GRAY, BROWN, BROWN, BROWN, GRAY, GRAY, GREEN, GREEN
	tilepal 1, GREEN, GREEN, GRAY, GRAY, RED, RED, RED, RED
