...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_KURT_OUTSIDE ; 62 NOW REDUNDANT (TOGO)
	const SPRITE_SUICUNE ; 63
	const SPRITE_ENTEI ; 64
	const SPRITE_ARCHETA ; 65
	const SPRITE_STANDING_YOUNGSTER ; 66 NOW REDUNDANT (TOGO)
	const SPRITE_TRAVEL_NURSE ; 67
	const SPRITE_FEATHERS	  ; 68
