...
; Johto hidden items
	const EVENT_PECKSHELL_HIDDEN_POKEBALL
	const EVENT_PECKSHELL_POTION
	const EVENT_TIN_TOWER_5F_HIDDEN_CARBOS
	const EVENT_BURNED_TOWER_1F_HIDDEN_ETHER
	const EVENT_PECKSHELL_HIDDEN_EXP_SHARE ; previously unused, now used for testing purposes
...
; Ruins of Alph puzzles
	const EVENT_SOLVED_HOGWYRE_PUZZLE
...
; More Johto story events
	...
	const EVENT_SHOWED_LOTAD_TO_BILLS_GRANDPA
...
; More Crystal-exclusive events in Johto
	const EVENT_WALL_OPENED_IN_HOGWYRE_CHAMBER
...
; Johto itemballs
	const EVENT_TORCHIC_POKEBALL_IN_ELMS_LAB
	const EVENT_MUDKIP_POKEBALL_IN_ELMS_LAB
	const EVENT_TREECKO_POKEBALL_IN_ELMS_LAB
...
; Johto people
	...
	const EVENT_GUARD_PECKSHELL_TOWN
	...
	const EVENT_TIN_TOWER_ROOF_HOGWYRE
	...
	const EVENT_SERPENT_FALLS_EKANS ;used to be lake of rage gyarados
...
; New to Crystal
	...
	const EVENT_PICKED_UP_GOLD_BERRY_FROM_HOGWYRE_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_HOGWYRE_ITEM_ROOM
	const EVENT_PICKED_UP_REVIVAL_HERB_FROM_HOGWYRE_ITEM_ROOM
	const EVENT_PICKED_UP_CHARCOAL_FROM_HOGWYRE_ITEM_ROOM
	...
	const EVENT_TIN_TOWER_1F_ARCHETA
	const EVENT_TIN_TOWER_1F_EUSINE
	const EVENT_TIN_TOWER_1F_WISE_TRIO_1
	const EVENT_SET_WHEN_FOUGHT_HOGWYRE
	const EVENT_ROUTE_50_POTION
