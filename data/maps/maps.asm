...
MapGroup_Stelursa:
	table_width MAP_LENGTH, MapGroup_Stelursa
	map StelursaTown, TILESET_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_POKE_FLUTE_CHANNEL, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map PetalfallPark, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_POKEMON_LULLABY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route65, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_44, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map StumpsLabRoof, TILESET_MART, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_PROF_OAK, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map StarterRoom, TILESET_LAB, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_PROF_OAK, FALSE, PALETTE_DAY, FISHGROUP_POND

	assert_table_length NUM_STELURSA_MAPS
...
MapGroup_Sintiri:
	...
	map SintiriLake, TILESET_JOHTO, ROUTE, LANDMARK_RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map Route52Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_32, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_POND
	map DragonscaleTower1F, TILESET_TOWER, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_SPROUT_TOWER, FALSE, PALETTE_DAY, FISHGROUP_POND
