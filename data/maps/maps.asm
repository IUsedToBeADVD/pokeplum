...
MapGroup_Stelursa:
	...
	map StelursaTown, TILESET_JOHTO, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map PetalfallPark, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_POKE_FLUTE_CHANNEL, FALSE, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup_Sintiri:
	...
	map SintiriLake, TILESET_JOHTO, ROUTE, LANDMARK_CHERRYGROVE_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
