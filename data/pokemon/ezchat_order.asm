...
.hi_bi_pi: db LOMBRE, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, LOTAD, CLEFAIRY, CHARMANDER, STARYU, TORCHIC, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, LUDICOLO, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
