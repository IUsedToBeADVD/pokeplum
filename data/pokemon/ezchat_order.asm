...
.a:        db EKANS, ARBOK, SEAKING, ARIADOS, MARSHTOMP, UNOWN, -1
...
.o:        db SWAMPERT, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.hi_bi_pi: db CLEFFA, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, CHARMANDER, STARYU, TORCHIC, SUNKERN, TEDDIURSA, VOLTORB, -1
