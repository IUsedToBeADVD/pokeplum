...
.o:        db SWAMPERT, LOPUNNY, OCTILLERY, PRIMEAPE, BUNEARY, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, DUBWOOL, CROBAT, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, BLAZIKEN, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, LUDICOLO, UMBREON, ARTICUNO, JIGGLYPUFF, WOOLOO, -1
