...
MonMenuIcons:
	...
	db ICON_FIGHTER     ; LEAFEON
	db ICON_FIGHTER     ; GLACEON
	db ICON_MONSTER     ; EMOLGA
	...
	db ICON_BLOB        ; APPLIN
	db ICON_BLOB        ; APPLETUN
	db ICON_EQUINE      ; SWINUB
	db ICON_EQUINE      ; PILOSWINE
	db ICON_SHELL       ; CORSOLA
	db ICON_FISH        ; DUDUNSPARCE_TWO
	db ICON_FISH        ; DUDUNSPARCE_THREE
