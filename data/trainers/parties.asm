...
FalknerGroup:
	...
	db  7, ROOKIDEE,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
KogaGroup:
	...
	db 40, VESPIQUEN,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, VESPIQUEN,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
