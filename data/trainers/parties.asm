...
FalknerGroup:
	; FALKNER (1)
	db "GOLDIE@", TRAINERTYPE_MOVES
	db  14, KRABBY,    BUBBLEBEAM, MUD_SLAP, FLAIL, THIEF
	db  13, PUBBLE,  WATER_GUN, MAGNITUDE, NO_MOVE, NO_MOVE
	db  16, POLIWHIRL,  SWAGGER, BUBBLEBEAM, MIND_READER, ICY_WIND
	db -1 ; end
...
PryceGroup:
	...
	db 27, WINGULL,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 29, PELIPPER,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
Rival1Group:
	...
	db 22, GROVYLE,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, COMBUSKEN,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, MARSHTOMP,   LEER, RAGE, WATER_GUN, BITE
	db -1 ; end
	...
	db 32, SCEPTILE,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, COMBUSKEN,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, SWAMPERT, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 38, SCEPTILE,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, BLAZIKEN, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, SWAMPERT, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
BrunoGroup:
	...
	db 42, SYLVEON,  PURSUIT, QUICK_ATTACK, DIG, DETECT
	db 42, LEAFEON,  SWAGGER, DOUBLE_KICK, HI_JUMP_KICK, FORESIGHT
	db 42, GLACEON, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
...
KogaGroup:
	...
	db 40, GUBBLER,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 41, SNOMYOMI,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 43, BASTIODON, PROTECT, SWIFT, EXPLOSION, SPIKES
...
LassGroup:
	...
	db 18, CRANIDOS,   SCARY_FACE, CHARM, BITE, LICK
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, GUBBLER,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	db 39, SNOMYOMI,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, EMOLGA,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 28, SNOMYOMI,   DISABLE, SUPERSONIC, CONFUSION, LEECH_LIFE
	db -1 ; end
	...
	; BUG_CATCHER (17)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 36, SNOMYOMI,   GUST, SUPERSONIC, PSYBEAM, LEECH_LIFE
	db -1 ; end

	; BUG_CATCHER (18)
	db "ARNIE@", TRAINERTYPE_MOVES
	db 40, SNOMYOMI,   GUST, SUPERSONIC, PSYCHIC_M, TOXIC
	db -1 ; end
...
FisherGroup:
	...
	db 25, DUDUNSPARCE_TWO,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, DUDUNSPARCE_TWO,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 25, SHELLDER
	db 29, DUDUNSPARCE_THREE
	db 25, DUDUNSPARCE_TWO
	db 29, CLOYSTER
	db -1 ; end

	; FISHER (13)
	db "MARTIN@", TRAINERTYPE_NORMAL
	db 32, DUDUNSPARCE_TWO
	db 32, DUDUNSPARCE_TWO
	db -1 ; end
	...
	db 34, CACTURNE,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 34, CACTURNE,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, DUDUNSPARCE_TWO,   PSYBEAM, AURORA_BEAM, BUBBLEBEAM, HYPER_BEAM
	db -1 ; end
	...
	db 39, CACTURNE,    ENDURE, FLAIL, FURY_ATTACK, WATERFALL
	db -1 ; end

	; FISHER (25)
	db "TULLY@", TRAINERTYPE_MOVES
	db 34, CACTURNE,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
	db 34, CACTURNE,    SUPERSONIC, RAIN_DANCE, WATERFALL, FURY_ATTACK
...
SwimmerFGroup:
	...
	db 22, CACNEA,    PECK, TAIL_WHIP, SUPERSONIC, HORN_ATTACK
	db -1 ; end
...
Rival2Group:
	...
	db 45, SCEPTILE,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, BLAZIKEN, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, SWAMPERT, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 50, SCEPTILE,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, BLAZIKEN, SMOKESCREEN, QUICK_ATTACK, FIRE_BLAST, SWIFT
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, SWAMPERT, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
BlaineGroup:
	...
	db 45, APPLETUN,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
...
BlackbeltGroup:
	...
	db 27, LEAFEON,  DOUBLE_KICK, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 36, LEAFEON,  DOUBLE_TEAM, HI_JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 27, GLACEON, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
CamperGroup:
	...
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 36, APPLETUN,   ROCK_THROW, HARDEN, AMNESIA, FLAMETHROWER
...
PokefanFGroup:
	...
	; POKEFANF (3)
	db "BEVERLY@", TRAINERTYPE_ITEM
	db 18, CRANIDOS,   BERRY
	db -1 ; end

	; POKEFANF (4)
	db "BEVERLY@", TRAINERTYPE_ITEM
	db 30, RAMPARDOS,   BERRY
	db -1 ; end
