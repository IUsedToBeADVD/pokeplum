...
FalknerGroup:
	...
	db  13, BARBOACH,  WATER_GUN, MAGNITUDE, NO_MOVE, NO_MOVE
...
PryceGroup:
	...
	db 27, SIZZLIPEDE,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 29, CNTISKORCH,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
KogaGroup:
	...
	db 40, WHISCASH,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, WHISCASH,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
...
FisherGroup:
	...
	db 25, JOLTIK,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db 25, JOLTIK,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
	...
	db 34, CACTURNE,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, JOLTIK,   PSYBEAM, AURORA_BEAM, BUBBLEBEAM, HYPER_BEAM
	db -1 ; end
