...
; entries correspond to SPRITE_ANIM_OAMSET_* constants (see constants/sprite_anim_constants.asm)
	...
	spriteanimoam $10, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_TREECKO
	spriteanimoam $29, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_TORCHIC
	spriteanimoam $42, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_MUDKIP
	...
	spriteanimoam $00, .OAMData_IntroLotad               ; SPRITE_ANIM_OAMSET_INTRO_LOTAD_1
	spriteanimoam $05, .OAMData_IntroLotad               ; SPRITE_ANIM_OAMSET_INTRO_LOTAD_2
	spriteanimoam $0a, .OAMData_IntroLotad               ; SPRITE_ANIM_OAMSET_INTRO_LOTAD_3
