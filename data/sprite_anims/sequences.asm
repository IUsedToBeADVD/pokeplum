...
; SPRITE_ANIM_INDEX_GS_INTRO_HOGWYRE_LUGIA
	db SPRITE_ANIM_FRAMESET_GS_INTRO_HOGWYRE_LUGIA,      SPRITE_ANIM_SEQ_GS_INTRO_HOGWYRE_LUGIA,      SPRITE_ANIM_DICT_DEFAULT
...
; SPRITE_ANIM_INDEX_INTRO_LOTAD
	db SPRITE_ANIM_FRAMESET_INTRO_LOTAD,               SPRITE_ANIM_SEQ_INTRO_LOTAD_WOOPER,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_WOOPER
	db SPRITE_ANIM_FRAMESET_INTRO_WOOPER,              SPRITE_ANIM_SEQ_INTRO_LOTAD_WOOPER,        SPRITE_ANIM_DICT_DEFAULT
